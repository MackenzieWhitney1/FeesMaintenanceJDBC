...
import static org.example.feesmaintenancejdbc.Validator.*;
...
public class DialogController {
    ...
    // set the mode for when the dialog opens
    ...
    // validate the fee inputs, display alert, and return a boolean
    ...
    // collect fee info for when fee is added/edited
